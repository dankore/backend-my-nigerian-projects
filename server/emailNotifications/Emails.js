                        ...
                        <tbody>
                          <tr>
                            <td style='padding:32px 30px 45px'>
                              <h1 style='font-family:Helvetica,Geneva,Tahoma,Verdana,sans-serif;text-decoration:none;color:#464646;line-height:10px;font-size:22px;font-weight:bold'>${projectData.title}</h1>
                              <span style='font-family:Helvetica,Geneva,Tahoma,Verdana,sans-serif;font-size:16px;line-height:28px;color:#555555;padding-top:0px'>${projectData.description}</span>
                            </td>
                          </tr>
                          <tr>
